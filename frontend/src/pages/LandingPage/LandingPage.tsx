      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pr-12 lg:pr-20 py-12 sm:py-16 flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
          ...
          <p className="text-lg text-gray-500 mb-6 max-w-2xl">
            Transform your agricultural transactions with secure, digital receipts. Verify authenticity instantly and build trust across the entire supply chain.
          </p>
          {/* Primary action button */}
          <div>
            <button className="flex items-center gap-2 px-7 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-xl shadow transition-all text-lg">
              <svg className="w-5 h-5 mr-1" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2l4-4" /></svg>
              Verify Receipt
            </button>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-600 mt-4 max-w-2xl mx-auto">
            Explore the powerful features that make Agri Receipts indispensable for modern agriculture.
          </p>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-start gap-10">
              ...
              <div className="w-full md:w-1/4 flex flex-col items-start mb-8 md:mb-0">
                <div className="flex items-center mb-4">
                  <img src={logo} alt="Agri Receipts Logo" className="h-10 w-auto mr-3 rounded-lg bg-white p-1" />
                  <span className="text-xl font-bold text-white">Agri Receipts</span>
                </div>
                <nav>
                  <ul className="space-y-2 mt-2">
                    <li><a href="#hero" className="text-gray-300 hover:text-white text-sm">Home</a></li>
                    <li><a href="#impact" className="text-gray-300 hover:text-white text-sm">Why Agri Receipts</a></li>
                    <li><a href="#add-receipts" className="text-gray-300 hover:text-white text-sm">Features</a></li>
                    <li><a href="#committees" className="text-gray-300 hover:text-white text-sm">Committees</a></li>
                  </ul>
                </nav>
              </div>
              {/* Center: Contributors */}
              <div className="w-full md:w-2/4 flex flex-col items-center">
                ...
                <h3 className="text-3xl font-bold mb-6 tracking-wider text-white">Contributors</h3>
                <div className="flex flex-col sm:flex-row gap-6 w-full justify-center">
                  ...
                  <div className="bg-white/10 hover:bg-white/20 transition-colors rounded-xl shadow-lg border border-emerald-300 flex-1 flex flex-col items-center px-4 py-4 min-w-[120px] max-w-[160px]">
                    ...
                    <span className="text-base text-white font-semibold mb-1">Srivathsa</span>
                    <div className="flex gap-2 mb-2">
                      <a href="https://www.linkedin.com/in/srivathsa/" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-blue-300">
                  ...
                  <div className="bg-white/10 hover:bg-white/20 transition-colors rounded-xl shadow-lg border border-emerald-300 flex-1 flex flex-col items-center px-4 py-4 min-w-[120px] max-w-[160px]">
                    ...
                    <span className="text-base text-white font-semibold mb-1">Ajay</span>
                    <div className="flex gap-2 mb-2">
                      <a href="https://www.linkedin.com/in/ajay/" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-blue-300">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11 19h-3v-9h3v9zm-1.5-10.28c-.97 0-1.75-.79-1.75-1.75s.78-1.75 1.75-1.75 1.75.79 1.75 1.75-.78 1.75-1.75 1.75zm15.5 10.28h-3v-4.5c0-1.08-.02-2.47-1.5-2.47-1.5 0-1.73 1.17-1.73 2.39v4.58h-3v-9h2.89v1.23h.04c.4-.75 1.37-1.54 2.82-1.54 3.01 0 3.57 1.98 3.57 4.56v4.75z" /></svg>
                      </a>
                      <a href="https://github.com/ajay" target="_blank" rel="noopener noreferrer" className="text-gray-100 hover:text-white">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.205 11.387.6.113.82-.262.82-.582 0-.288-.01-1.05-.015-2.06-3.338.726-4.042-1.61-4.042-1.61-.546-1.387-1.333-1.756-1.333-1.756-1.09-.745.083-.729.083-.729 1.205.085 1.84 1.237 1.84 1.237 1.07 1.834 2.807 1.304 3.492.997.108-.775.418-1.305.762-1.605-2.665-.304-5.466-1.332-5.466-5.93 0-1.31.468-2.38 1.236-3.22-.124-.303-.535-1.523.117-3.176 0 0 1.008-.322 3.3 1.23a11.5 11.5 0 0 1 3.003-.404c1.02.005 2.047.138 3.003.404 2.29-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.873.12 3.176.77.84 1.235 1.91 1.235 3.22 0 4.61-2.803 5.624-5.475 5.92.43.37.823 1.102.823 2.222 0 1.606-.015 2.898-.015 3.293 0 .322.218.698.825.58C20.565 21.796 24 17.297 24 12c0-6.63-5.37-12-12-12z" /></svg>
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/10 hover:bg-white/20 transition-colors rounded-xl shadow-lg border border-emerald-300 flex-1 flex flex-col items-center px-4 py-4 min-w-[120px] max-w-[160px]">
                    ...
                    <span className="text-base text-white font-semibold mb-1">Sasi Kumar</span>
                    <div className="flex gap-2 mb-2">
                      <a href="https://www.linkedin.com/in/sasikumar/" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-blue-300">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11 19h-3v-9h3v9zm-1.5-10.28c-.97 0-1.75-.79-1.75-1.75s.78-1.75 1.75-1.75 1.75.79 1.75 1.75-.78 1.75-1.75 1.75zm15.5 10.28h-3v-4.5c0-1.08-.02-2.47-1.5-2.47-1.5 0-1.73 1.17-1.73 2.39v4.58h-3v-9h2.89v1.23h.04c.4-.75 1.37-1.54 2.82-1.54 3.01 0 3.57 1.98 3.57 4.56v4.75z" /></svg>
                      </a>
                      <a href="https://github.com/sasikumar" target="_blank" rel="noopener noreferrer" className="text-gray-100 hover:text-white">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.205 11.387.6.113.82-.262.82-.582 0-.288-.01-1.05-.015-2.06-3.338.726-4.042-1.61-4.042-1.61-.546-1.387-1.333-1.756-1.333-1.756-1.09-.745.083-.729.083-.729 1.205.085 1.84 1.237 1.84 1.237 1.07 1.834 2.807 1.304 3.492.997.108-.775.418-1.305.762-1.605-2.665-.304-5.466-1.332-5.466-5.93 0-1.31.468-2.38 1.236-3.22-.124-.303-.535-1.523.117-3.176 0 0 1.008-.322 3.3 1.23a11.5 11.5 0 0 1 3.003-.404c1.02.005 2.047.138 3.003.404 2.29-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.873.12 3.176.77.84 1.235 1.91 1.235 3.22 0 4.61-2.803 5.624-5.475 5.92.43.37.823 1.102.823 2.222 0 1.606-.015 2.898-.015 3.293 0 .322.218.698.825.58C20.565 21.796 24 17.297 24 12c0-6.63-5.37-12-12-12z" /></svg>
                      </a>
                    </div>
                  </div>
              ...
              <div className="w-full md:w-1/4 flex flex-col items-start md:items-end justify-center mt-8 md:mt-0 pr-0 md:pr-12 lg:pr-16">
                <div className="flex flex-col justify-center h-full w-full md:items-end">
                  <h3 className="text-xl md:text-2xl font-bold text-white flex items-center gap-2 mb-2">
                    <svg className="w-6 h-6 text-green-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M21 8V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2m18 0v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8m18 0l-9 6l-9-6" /></svg>
                    Contact Us
                  </h3>
                  <div className="w-8 h-1 bg-green-500 rounded mb-4"></div>
                  <p className="text-sm text-gray-200 mb-4 max-w-xs text-left md:text-right">For any complaints or suggestions, feel free to reach out to us via email.</p>
                  <a
