  ...
  const quickActions = [
    {
      ...
      description:
        'Create a new agricultural transaction receipt for market fees, licenses, or other charges.',
      icon: <FiPlus size={24} />,
    ...
    },
    {
      ...
      title: 'View Receipts',
      description:
        'Access and manage all existing agricultural transaction receipts in one place.',
      icon: <FiEye size={24} />,
    ...
    <div className='max-w-7xl mx-auto p-6 space-y-8'>
      ...
      <div className='text-center space-y-4'>
        ...
        <p className='text-lg text-neutral-600 max-w-3xl mx-auto leading-relaxed'>
          Efficiently manage all your agricultural transaction receipts. Keep
          track of market fees, licenses, and other charges for farming
        ...
        {quickActions.map((action) => (
          <Card
            ...
            <CardContent className='text-center space-y-6'>
              <div
                className={`inline-flex items-center justify-center w-16 h-16 ${action.bgColor} rounded-2xl group-hover:scale-110 transition-transform duration-300`}>
