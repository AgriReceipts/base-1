...
import { FiFileText, FiDownload, FiCalendar, FiChevronDown } from 'react-icons/fi';

export default function Reports() {
  const reports = [
    { id: 1, name: 'Monthly Compliance Report', type: 'PDF', date: 'Jun 1, 2023', size: '2.4 MB' },
    { id: 2, name: 'Trader Activity Summary', type: 'Excel', date: 'May 1, 2023', size: '1.8 MB' },
    { id: 3, name: 'Committee Performance', type: 'PDF', date: 'Apr 1, 2023', size: '3.2 MB' },
    { id: 4, name: 'Quarterly Audit Report', type: 'PDF', date: 'Mar 15, 2023', size: '4.5 MB' },
    { id: 5, name: 'Annual Compliance Review', type: 'PDF', date: 'Jan 1, 2023', size: '5.1 MB' },
  ];
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
        <div className="p-4 border-b border-gray-200 flex flex-col md:flex-row md:items-center md:justify-between">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm text-gray-500">Generated reports and documents</p>
          </div>
        ...
        <div className="divide-y divide-gray-200">
          {reports.map((report) => (
            <div key={report.id} className="p-4 flex flex-col md:flex-row md:items-center md:justify-between">
