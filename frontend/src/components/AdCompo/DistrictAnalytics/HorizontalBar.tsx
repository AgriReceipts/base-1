...
> = ({data}) => {
  ...
  return (
    <div className='space-y-4'>
      ...
      {/* Legend - only show if there are targets */}
      {hasTargets && (
      ...
      {data.map((committee, index) => {
        ...
        return (
          <div
              ...
              {hasTarget ? (
                ...
                <>
                  ...
                  <div className='w-full h-7 bg-gray-100 rounded-lg overflow-hidden relative'>
                    ...
                    {/* Achievement Bar (overlays on target) */}
                    <div
                    ...
                    {/* Overflow indicator for over-achievement */}
                ...
                /* No target - show only market fees */
                <>
                  <div className='w-full h-7 bg-gray-100 rounded-lg overflow-hidden relative'>
                    {/* Market Fees Bar */}
                    <div
            ...
            {/* Achievement Badge - only show if there's a target */}
            {hasTarget && (
              <div
            ...
            {/* Status Indicator - only show if there's a target */}
            {hasTarget && (
              <div className='flex items-center gap-1'>
                <div
